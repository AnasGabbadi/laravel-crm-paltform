...
<div class="d-flex align-items-center justify-content-between">
    ...
    <a href="{{route('orders.create')}}" class="btn btn-primary"><img src="{{ asset('assets_dashboard/img/p2.png') }}" alt="" style="width: 15px;margin-right: 8px;margin-top: -4px;">Add User</a>
</div>
<br><br><br><br>
                            ...
                            <td>
                                <div class="filter">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                        <li><a class="dropdown-item" href="{{ route('orders.edit', $rs->id) }}" type="button">Edit</a></li>
                                        <li>
                                            <form class="btn p-0" action="{{ route('orders.destroy', $rs->id) }}" method="POST" type="button" onsubmit="return confirm('Delete?')">
                                                @csrf
                                                @method('DELETE')
